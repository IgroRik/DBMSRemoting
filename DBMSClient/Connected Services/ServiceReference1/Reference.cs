...
namespace DBMSClient.ServiceReference1 {
    ...
    public interface IDBMSService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action= "http://tempuri.org/IDBMSService/TablesProjection", ReplyAction= "http://tempuri.org/IDBMSService/TablesProjectionResponse")]
        DBMSClient.ServiceReference1.Table TablesProjection(DBMSClient.ServiceReference1.Table table);
        
        [System.ServiceModel.OperationContractAttribute(Action= "http://tempuri.org/IDBMSService/TablesProjection", ReplyAction= "http://tempuri.org/IDBMSService/TablesProjectionResponse")]
        System.Threading.Tasks.Task<DBMSClient.ServiceReference1.Table> TablesProjectionAsync(DBMSClient.ServiceReference1.Table table);

        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/IDBMSService/TablesProjectionByColumn", ReplyAction = "http://tempuri.org/IDBMSService/TablesProjectionByColumnResponse")]
        DBMSClient.ServiceReference1.Table TablesProjectionByColumn(DBMSClient.ServiceReference1.Table table, string columnName);

        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/IDBMSService/TablesProjectionByColumn", ReplyAction = "http://tempuri.org/IDBMSService/TablesProjectionByColumnResponse")]
        System.Threading.Tasks.Task<DBMSClient.ServiceReference1.Table> TablesProjectionByColumnAsync(DBMSClient.ServiceReference1.Table table, string columnName);
    }
    ...
    public partial class DBMSServiceClient : System.ServiceModel.ClientBase<DBMSClient.ServiceReference1.IDBMSService>, DBMSClient.ServiceReference1.IDBMSService {
        ...
        public DBMSClient.ServiceReference1.Table TablesProjection(DBMSClient.ServiceReference1.Table table) {
            return base.Channel.TablesProjection(table);
        }
        
        public System.Threading.Tasks.Task<DBMSClient.ServiceReference1.Table> TablesProjectionAsync(DBMSClient.ServiceReference1.Table table) {
            return base.Channel.TablesProjectionAsync(table);
        }

        public DBMSClient.ServiceReference1.Table TablesProjectionByColumn(DBMSClient.ServiceReference1.Table table, string columnName)
        {
            return base.Channel.TablesProjectionByColumn(table, columnName);
        }

        public System.Threading.Tasks.Task<DBMSClient.ServiceReference1.Table> TablesProjectionByColumnAsync(DBMSClient.ServiceReference1.Table table, string columnName)
        {
            return base.Channel.TablesProjectionByColumnAsync(table, columnName);
        }
    }
}
