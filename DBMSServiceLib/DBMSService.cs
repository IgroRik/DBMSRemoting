...
namespace DBMSServiceLib
{
    ...
    public class DBMSService : IDBMSService
    {
        ...
        public Table TablesProjection(Table table)
        {
            return dbManager.TableProjection(table);
        }

        public Table TablesProjectionByColumn(Table table, string columnName)
        {
            return dbManager.TableProjection(table, columnName);
        }
    }
}
